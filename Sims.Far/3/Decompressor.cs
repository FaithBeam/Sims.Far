        ...
        if (Data.Length > 6)
        {
            ...
            while (index < Data.Length - 3)
            {
                ...
                do
                {
                    ...
                    int mapindex = Data[index] + (Data[index + 1] << 8) + (Data[index + 2] << 16);
                ...
                while ((loopcount < indexList!.Count) && (loopcount < QFS_MAXITER))
                {
                    ...
                    while (
                        ...
                        && (Data[index + copyCount] == Data[foundindex + copyCount])
                ...
                if (offsetCopyCount > 0)
                {
                    ...
                    if ((offsetCopyCount <= 0x0A) && (copyOffset < 0x400))
                    {
                        cData[writeIndex++] = (byte)(
                            ((copyOffset >> 8) << 5) + ((offsetCopyCount - 3) << 2) + copyCount
                        );
        ...
        if (Data.Length > 6)
        {
            ...
            while (Control1 != 0xFC && Pos < Data.Length)
            {
                ...
                else if (Control1 >= 192 && Control1 <= 223)
                {
                    ...
                    int offset = (int)(
                        ((Control1 & 0x10) << 12) + (control2 << 8) + (control3) + 1
                    );
